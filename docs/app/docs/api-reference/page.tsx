...
const ROWS: [string, string][] = [
  ...
  ["ConversationEngine / VoiceActivityDetector / InterruptionController", "Deterministic conversation engine + VAD + confidence-gated barge-in"],
  ["IntentTracker / ClarificationPolicy / ResponseShaper", "Goal tracking (Session-backed), clarification, and voice response shaping"],
  ["deepgramSTT(opts?) / elevenLabsTTS(opts?)", "STT/TTS adapters (optional lazy peers @deepgram/sdk, elevenlabs)"],
  ["WebRTCVoiceTransport + webrtc-signaling helpers", "Browser RTCPeerConnection (Node mock fallback) + createOffer/handleAnswer/handleOffer/addIceCandidate"],
  ...
  ["createMockSTTProvider / createMockTTSProvider / createMockVoiceTransport", "Deterministic mock STT/TTS/transport for voice tests (no audio deps)"],
